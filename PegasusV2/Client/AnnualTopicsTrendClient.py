...
class AnnualTopicsTrendClient:
    def visualize_trending_topics(self, domain, year, k):
    ...
    def visualize_annual_tag_trend(self, domain, tag):
...
if __name__ == "__main__":
    client = AnnualTopicsTrendClient()
